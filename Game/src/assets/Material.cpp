...
void MaterialData::setVec2(const std::string &name, glm::vec2 vec2)
{
    vec2s[name].value=vec2;
}

void MaterialData::setVec3(const std::string &name, glm::vec3 vec3)
{
    vec3s[name].value=vec3;
}

void MaterialData::setVec4(const std::string &name, glm::vec4 vec4)
{
    vec4s[name].value=vec4;
}

void MaterialData::setMat2(const std::string &name, glm::mat2 mat2)
{
    mat2s[name].value=mat2;
}

void MaterialData::setMat3(const std::string &name, glm::mat3 mat3)
{
    mat3s[name].value=mat3;
}

void MaterialData::setMat4(const std::string &name, glm::mat4 mat4)
{
